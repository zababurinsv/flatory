 ...
 * Reviews controller
 */
class Reviews extends MY_FrontController {
    ...
    public function __construct() {
        ...
        $this->_category = $this->File_Categories->get_by_field('prefix', 'reviews');
...
//            'list' => $list,
     ...
     */
    public function reviews_item($alias, $is_preview = FALSE) {
