 ...
 * News controller
 */
class News extends MY_FrontController {
    ...
    public function __construct() {
        ...
        $this->_category = $this->File_Categories->get_by_field('prefix', 'news');
...
//            'list' => $list,
     ...
     */
    public function news_item($alias, $is_preview = FALSE) {
