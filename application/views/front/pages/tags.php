<h1 class="page-name"><?= element('name', $tag) ?></h1>
<ul class="list-unstyled">
    <?php foreach ($list as $it): $cat = element(element('file_category_id', $it), $categories, array()); ?>
        <li class="news_page_item">
            ...
            <div class="news_page_anons">
                ...
                <span class="news_date"><?= get_full_date_ru(element('created', $it)) ?></span>
