...
<div class="content_space">
    <?foreach($news_item as $key => $val){?>
        ...
        <div style="float:right;height: 20px;"><a class="news_read_more" style="position: relative;top:10px;font-size: 14px;" href="/news/"><img style="margin-top: -2px;" src="/images/arrow.png" alt=""/>Все новости</a></div>
