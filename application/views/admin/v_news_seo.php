...
<div class="row">
    ...
    <div class="tabbable"> <!-- Only required for left/right tabs -->
        <ul class="nav nav-tabs">
           <li <?if($this->uri->segment(3)=='edit'){?> class="active"<?}?>><a <?='href="/admin/news/edit/'.$object_id.'"'?> >Новость</a></li>
           <li <?if($this->uri->segment(3)=='seo'){?> class="active"<?}?>><a <?='href="/admin/news/seo/'.$object_id.'"'?> >Мета-теги</a></li>
        </ul>
        <div class="tab-content">
            <div class="tab-pane active" id="tab2">
                <br/>
                <form class="form-horizontal" action="/admin/news/seo/<?=$object_id?>" enctype="multipart/form-data" method="POST" >
