...
<div class="hpanel<?= $panel_class ?>">
                    ...
                    <div class="clearfix">
                        <?php foreach ($infrastructure_list as $group_name => $group_list): ?>
                            <div class="js-by-colomns-item">
                                <h4 class="category-name space_top space_bottom_none"><?= $group_name ?></h4>
                                    ...
                                    <div class="chx-w-inp" data-group="0" data-registry_id="<?= $registry_id = array_get($item, 'registry_id') ?>">
                                        <label class="checkbox-inline">
                                            <div class="icheckbox_square-green">
                                                <input type="checkbox" class="i-checks" name="registry[0][<?= $registry_id ?>][registry_id]" value="<?= $registry_id ?>">
                            ...
                            <div class="js-by-colomns-item-sec">
                                ...
                                <?php foreach ($group_list as $item): ?>
                                    <div class="chx-w-inp" data-group="1" data-registry_id="<?= $registry_id = array_get($item, 'registry_id') ?>">
                                        <label class="checkbox-inline">
                                            <div class="icheckbox_square-green">
                                                <input type="checkbox" class="i-checks" name="registry[1][<?= $registry_id ?>][registry_id]" value="<?= $registry_id ?>">
                                                <ins class="iCheck-helper"></ins>
                                            </div>
                                            <?= array_get($item, 'name') ?>
                                        </label>
    ...
    <?php endif; ?>
                    (function () {
                        ...
                        $('.chx-w-inp [type="checkbox"]').on('ifChanged', function (e) {
                            var p = $(this).parents('.chx-w-inp');
