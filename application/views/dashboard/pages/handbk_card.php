...
<div class="container-fluid">
            ...
            <div class="row">
                ...
                <div class="col-md-6">
                    <nav> 
                        ...
                        <?php endif ?>
                        <button type="button" name="save_page_form" data-handbk-action="save_page_form" class="btn btn-success">Сохранить</button>
                    </nav>
                </div>
            </div>
        </header>
    ...
    <div class="hpanel">
        <div class="panel-body" data-handbk-card="">
            <?= $content ?>
        </div>
    </div>
    <script>
        (function () {
            ...
            $('[data-handbk-card] form [type="submit"]').parents('.form-group').hide();
            
            $('[data-handbk-action="save_page_form"]').on('click', function (e) {
                $('[data-handbk-card] form').submit();
            });
        }());
    </script>
</div>