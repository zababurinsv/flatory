<form action="/admin/storage/" class="fl-filter space_bottom">
    ...
    <div class="more_filters" style="display: none;">
        ...
        <div class="row">
            ...
            <div class="col-md-4">
                <div class="form-group">
                    <label for="file_format_id" class="control-label">Формат</label>
                    <div class="fl-filter-checkbox-list">
                        <?php foreach ($file_formats as $it): ?>
                            <label class="checkbox-inline">
                                <input type="checkbox" name="file_format_id[]" value="<?= $it['file_format_id'] ?>"> <?= $it['ext'] ?>
                            </label>
                        <?php endforeach; ?>
                    </div>
                </div>
