...
class CI_DB_active_record extends CI_DB_driver {
	 ...
	 *
	 * @param	string	The field to search
	 * @param	int	The values searched on
	 * @return	object
	 */
	public function where_find_in_set($key = NULL, $value = NULL)
	{
		return $this->_where_find_in_set($key, $value);
	}
        // ---------------------------------------------------------------
	/**
	 * Where_FIND_IN_SET
	 *
	 * Called by where_find_in_set
	 *
	 * @param	string	The field to search
	 * @param	int	The values searched on
	 * @param	boolean	If the statement would be IN or NOT IN
	 ...
	 * @return	object
	 */
	protected function _where_find_in_set($key = NULL, $value = NULL, $not = FALSE, $type = 'AND ')
	{
		...
		$where_in = $prefix . $not . " FIND_IN_SET (". $this->escape($value) .", `". $key ."`) ";
	...
	protected function _compile_select($select_override = FALSE)
	{
		...
		else
		{
			$sql = ( ! $this->ar_distinct) ? 'SELECT ' : 'SELECT DISTINCT ';
                        ...
                        // $ar_found_rows
                        $sql = ( !$this->ar_found_rows) ? $sql : $sql . 'SQL_CALC_FOUND_ROWS ';
